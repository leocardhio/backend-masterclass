...
type Querier interface {
	...
	GetTransfersByReceiverId(ctx context.Context, arg GetTransfersByReceiverIdParams) ([]Transfer, error)
	GetTransfersBySenderId(ctx context.Context, arg GetTransfersBySenderIdParams) ([]Transfer, error)
