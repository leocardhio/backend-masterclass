...
// Source: github.com/leocardhio/masterclass/db/sqlc (interfaces: Store)
...
// GetTransfersByReceiverId mocks base method.
func (m *MockStore) GetTransfersByReceiverId(arg0 context.Context, arg1 db.GetTransfersByReceiverIdParams) ([]db.Transfer, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetTransfersByReceiverId", arg0, arg1)
	ret0, _ := ret[0].([]db.Transfer)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetTransfersByReceiverId indicates an expected call of GetTransfersByReceiverId.
func (mr *MockStoreMockRecorder) GetTransfersByReceiverId(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetTransfersByReceiverId", reflect.TypeOf((*MockStore)(nil).GetTransfersByReceiverId), arg0, arg1)
}

// GetTransfersBySenderId mocks base method.
func (m *MockStore) GetTransfersBySenderId(arg0 context.Context, arg1 db.GetTransfersBySenderIdParams) ([]db.Transfer, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetTransfersBySenderId", arg0, arg1)
	ret0, _ := ret[0].([]db.Transfer)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetTransfersBySenderId indicates an expected call of GetTransfersBySenderId.
func (mr *MockStoreMockRecorder) GetTransfersBySenderId(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetTransfersBySenderId", reflect.TypeOf((*MockStore)(nil).GetTransfersBySenderId), arg0, arg1)
}
